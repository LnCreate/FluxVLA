...
from fluxvla.models.third_party_models.cosmos3.data.vfm.sequence_packing import ModalityData
...
class TimestepEmbedder(nn.Module):
    ...
    def forward(self, t):
        ...
        # FluxVLA vendor patch: keep timestep embeddings in the module dtype so
        # bf16 Cosmos3 training/inference does not hit mixed-dtype Linear ops.
