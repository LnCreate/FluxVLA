...
#
# Cosmos3-Nano full finetune on LIBERO-Object benchmark.
#
# Usage (8 GPU):
#   torchrun --nproc-per-node=8 scripts/train.py \
#     --config configs/cosmos3/cosmos3nano_libero_object_full_finetune.py
#
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        statistics_overrides=dict(
            libero_object_no_noops=dict(action=_libero_action_stats)),
        datasets=dict(
            type='ParquetDataset',
